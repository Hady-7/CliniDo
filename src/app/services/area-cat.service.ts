...
export class AreaCatService {
  ...
  getAreas(){
    return[
      ...
      new DrArea(101,15,'Marina'),
      new DrArea(102,15,'Kelo Batra'),
      new DrArea(103,15,'Ageba'),
      new DrArea(104,16,'El-sadat'),
      new DrArea(105,16,'shben El-kom'),
      new DrArea(106,16,'Mnof'),
      new DrArea(107,16,'Ashmon'),
      new DrArea(108,16,'Tala'),
      new DrArea(109,16,'El shohdaa'),
      new DrArea(110,16,'Gowsna'),
      new DrArea(111,16,'El Bagor'),
